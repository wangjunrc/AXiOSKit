...
- (void)viewDidLoad {
    ...
    [self _buttonTitle:@"请求1" handler:^(UIButton * _Nonnull btn) {
    ...
    [self _buttonTitle:@"请求2" handler:^(UIButton * _Nonnull btn) {
        NSDictionary *dict = @{@"name":@"jim",@"age":@1};
    ...
    [self _buttonTitle:@"请求3" handler:^(UIButton * _Nonnull btn) {
        NSDictionary *dict = @{@"name":@"jim",@"age":@1};
    ...
    [self _buttonTitle:@"请求ax.com" handler:^(UIButton * _Nonnull btn) {
        NSDictionary *dict = @{@"name":@"jim",@"age":@1};
