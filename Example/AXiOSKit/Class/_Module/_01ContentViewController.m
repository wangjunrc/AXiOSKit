...
-(void)_28_helper {
    ...
    [self _buttonTitle:@"AXHelper" handler:^(UIButton * _Nonnull btn) {
        
        AXHelper.helper.isDebug(^{
            NSLog(@"_28_helper-AXHelper");
        }).isRelease(^{
    ...
    [self _buttonTitle:@"_TestHelper" handler:^(UIButton * _Nonnull btn) {
        
        _TestHelper.helper.isDebug(^{
            NSLog(@"_28_helper-helper-_TestHelper");
        }).isRelease(^{
    ...
    [self _buttonTitle:@"_TestHelper" handler:^(UIButton * _Nonnull btn) {
        ...
        _TestHelper.alloc.init.isDebug(^{
            NSLog(@"_28_helper-_TestHelper");
        }).isRelease(^{
