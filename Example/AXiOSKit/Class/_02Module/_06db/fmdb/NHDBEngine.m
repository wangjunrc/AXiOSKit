...
static NSString *NHDBCipherKey = @"abc123";
static NSString *NHDBNAME = @"test_securityInfo12.sqlite";
...
@interface _FMDatabaseQueue : FMDatabaseQueue

@end

@implementation _FMDatabaseQueue
+ (Class)databaseClass{
...
@property (nonatomic, strong, nullable)_FMDatabaseQueue *dbQueue;
