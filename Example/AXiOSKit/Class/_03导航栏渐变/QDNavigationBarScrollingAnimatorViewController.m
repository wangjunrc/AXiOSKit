...
//        return [[UIImage qmui_imageWithColor:UIColor.orangeColor] qmui_imageWithAlpha:progress];
//    };
...
//        return [UIColor qmui_colorFromColor:UIColorBlack toColor:UIColor.redColor progress:progress];
//    };
...
//    };
    ...
    self.navigationAnimator.animationBlock = ^(QMUINavigationBarScrollingAnimator * _Nonnull animator, float progress) {
        animator.titleViewTintColorBlock = ^UIColor * _Nonnull(QMUINavigationBarScrollingAnimator * _Nonnull animator, float progress) {
            return [UIColor qmui_colorFromColor:UIColorBlack toColor:UIColor.redColor progress:progress];
        };
...
//
//
//    return [UIColor.greenColor colorWithAlphaComponent:self.navigationAnimator.progress];
//}
