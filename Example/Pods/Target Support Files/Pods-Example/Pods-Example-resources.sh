...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AXiOSTools/AXiOSTools_bundle_base.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AXiOSTools/AXiOSToolsWeb.bundle"
