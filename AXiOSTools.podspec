#
#  Be sure to run `pod spec lint AXiOSTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "AXinger"
  # s.authors            = { "AXinger" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/AXinger"
  ...
  # s.exclude_files = "AXiOSTools/Exclude"
