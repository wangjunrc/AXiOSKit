 ...
 * 动画时间
 */
#define DEF_duration 0.35f


/**
 * 旋转一圈
 */
#define DEF_circle [NSNumber numberWithFloat:(2 * M_PI) * 1]
 ...
 *
 *                        便利构造函数 animationWithKeyPath: KeyPath需要一个字符串类型的参数,实际上是一个
 ...
 *
 *  duration             动画持续时间,值得一提的是,如果添加到group里的子动画不设置此属性,group里的duration会统一
