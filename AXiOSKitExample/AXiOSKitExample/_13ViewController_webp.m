...
- (void)viewDidLoad {
  ...
  NSString *path = [[NSBundle mainBundle] pathForResource:@"header"
                                                   ofType:@"webp"
                                              inDirectory:@"images.bundle"];
  ...
  [self.imageView2
      sd_setImageWithURL:
          [NSURL
              URLWithString:@"http://images21.happyjuzi.com/test/ea/09/"
                            @"91f522741b7a0976b5f21a3b9f78.jpg!200.nw.webp"]];
  ...
  [self.animatedImageView3
      sd_setImageWithURL:
          [NSURL URLWithString:@"http://img.autohome.com.cn/album/2009/3/16/"
                               @"52bba7e6-1b9e-4ebb-b887-56b41be4ba2a.gif"]];
}

- (IBAction)toSaveImage:(id)sender {
  //   NSURL *URL =  [NSURL
  //   URLWithString:@"http://img.autohome.com.cn/album/2009/3/16/52bba7e6-1b9e-4ebb-b887-56b41be4ba2a.gif"];
  //    NSData *data =[NSData dataWithContentsOfURL:URL];

  //    NSString *path = [[NSBundle mainBundle] pathForResource:@"122"
  //    ofType:@"GIF"];
