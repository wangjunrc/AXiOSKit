        ...
        [manager setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
            switch (status) {
                case AFNetworkReachabilityStatusUnknown: // 未知网络
                    ...
                    [HNotificationCenter postNotificationName:NetWorkStatusNotification object:nil userInfo:@{@"status":@"Unknown"}];
                    break;
                    
                case AFNetworkReachabilityStatusNotReachable: // 没有网络(断网)
                    block(NetWorkStatusNotReachable);
                     [HNotificationCenter postNotificationName:NetWorkStatusNotification object:nil userInfo:@{@"status":@"NotReachable"}];
                    break;
                    
                case AFNetworkReachabilityStatusReachableViaWWAN: // 手机自带网络
                    block(NetWorkStatusWAN);
                    [HNotificationCenter postNotificationName:NetWorkStatusNotification object:nil userInfo:@{@"status":@"WAN"}];
                    break;
                    
                case AFNetworkReachabilityStatusReachableViaWiFi: // WIFI
                    block(NetWorkStatusWiFi);
                    [HNotificationCenter postNotificationName:NetWorkStatusNotification object:nil userInfo:@{@"status":@"WiFi"}];
                    break;
