...
NSString *const ax_cellID = @"TableViewacellID";

NSString *const ax_headID = @"TableViewCellheadID";

NSString *const ax_footID = @"TableViewCellfootID";

NSString *const ax_UserInfoSaveDict = @"ax_UserInfoSaveDict";

NSString *const ax_estimatedProgress = @"estimatedProgress";

NSString *const ax_title = @"title";
