...
//  AXTools
//
//  Created by Mole Developer on 16/6/20.
...
//    self.estimatedItemSize = CGSizeMake(kScreenWidth-space*2, kScreenHeight-64-10);
//    self.itemSize = CGSizeMake(kScreenWidth-space*2, kScreenHeight-64-10); //item尺寸
//    self.scrollDirection =UICollectionViewScrollDirectionHorizontal;//滚动方向
    ...
    self.minimumInteritemSpacing = 0;//列间距
    self.minimumLineSpacing = 0;//行间距
    self.itemSize = CGSizeMake(kScreenWidth, kScreenHeight-64); //item尺寸
    self.scrollDirection =UICollectionViewScrollDirectionHorizontal;//滚动方向
