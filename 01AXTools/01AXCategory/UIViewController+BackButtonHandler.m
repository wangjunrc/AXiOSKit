...
//    if([vc respondsToSelector:@selector(ax_navigationShouldPopOnBackButton)]) {
//        shouldPop = [vc ax_navigationShouldPopOnBackButton];
//    }
//
//    if(shouldPop) {
...
//        UIViewController *vc = [self topViewController];
//        if([vc respondsToSelector:@selector(ax_navigationShouldPopOnBackButton)]) {
//            return [vc ax_navigationShouldPopOnBackButton];
//        }
